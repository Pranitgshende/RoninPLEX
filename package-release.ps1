...
Write-Host "Copying MSI..."
Copy-Item "src-tauri\target\release\bundle\msi\*.msi" -Destination $releaseDir -Force

Write-Host "Copying NSIS..."
Copy-Item "src-tauri\target\release\bundle\nsis\*.exe" -Destination $releaseDir -Force
